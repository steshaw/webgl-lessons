...
function initScene(canvasId, animationState, animate, drawScene) {
  ...
  function doAnimate() {
    ...
    animationState = animate(prevTime, now, animationState);
    prevTime = now;
  }

  function tick(animationTime) {
    drawScene(gl, shaderProgram, buffers, animationTime, animationState);
    doAnimate();
